...
/// </remarks>
public sealed partial class MyTlsOverPerCoreLockedStacksArrayPool<T> : ArrayPool<T>
{
    ...
    private ThreadLocalArray[] InitializeTlsBucketsAndTrimming()
    {
        ...
        {
            Gen2GcCallback.Register(s => ((MyTlsOverPerCoreLockedStacksArrayPool<T>)s).Trim(), this);
        }
